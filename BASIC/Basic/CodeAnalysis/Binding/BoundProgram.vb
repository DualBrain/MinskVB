...
Namespace Global.Basic.CodeAnalysis.Binding
  ...
  Friend NotInheritable Class BoundProgram
    ...
    Public Sub New(previous As BoundProgram, diagnostics As ImmutableArray(Of Diagnostic), functions As ImmutableDictionary(Of FunctionSymbol, BoundBlockStatement), statement As BoundBlockStatement)
